...
<article class="post col-6 col-sm-3">
	<div class="post-inner">
        <figure class="post-thumb">
            <a href="/posts/{{ $post->id }}"><div style="height:235px; width:175px; background-image: url('{{ $post->image }}'); background-size: cover; background-repeat: no-repeat; background-position: 50% 50%;"  /></div>                                
        </figure><!--//post-thumb-->
        <div class="content">
