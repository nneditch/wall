<ul class="nav navbar-nav">
    <li class="dropdown nav-item"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="https://d13yacurqjgara.cloudfront.net/users/120724/screenshots/3261034/resist-flag_1x.jpg"
		alt="Alternate Text" class="user-tiny" /> &nbsp;{{ Auth::user()->name }}
        <b class="caret"></b></a>
            ...
            <li>
                <div class="navbar-content">
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div style="color: #253340;">{{ Auth::user()->name }}</div>
                            <p class="text-muted small">
                                {{ Auth::user()->email }}<br />Notifications <span style="color:#009900;">ON</span><br />
